...
- \fancyfoot[C]{\cincopuntos \thepage \\ \vspace{-0.2cm} ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ \\ \vspace{-0.2cm} \cincopuntos CONVENIO DE DESEMPEÑO 2021 IFOP/SUBSECRETARÍA DE ECONOMíA Y EMT \\ \vspace{-0.1cm} DOCUMENTO TÉCNICO. SARDINA AUSTRAL, REGIÓN DE LOS LAGOS, 2022}
---
...
```{=tex}
\small
\textbf{Figura 1}. Distribución de \textit{S. fuegensis} en el extremo sur de Sudamérica y focalización del área de estudio (recuadro) en el mar interior de la isla de Chiloé, Chile (41º9' a 43º5' S). 
\normalsize 
\vspace{0.5cm}
```
...
\vspace{-0.1cm}
\small
\textbf{Figura 3}. Estructura de tallas mensual de las capturas de sardina austral (enero 2017 -- junio 2020), en aguas interiores de la Región de Los Lagos.
\normalsize 
\vspace{0.5cm}
```
## 2.5. Reproducción
...
```{=tex}
\begin{center}
\includegraphics[width=0.9\textwidth]{Figuras/Fig4.png}
\end{center}
```
```{=tex}
\small
\textbf{Figura 4}. Procedimiento de evaluación de stock de sardina austral de la Región de Los Lagos.
\normalsize 
\vspace{0.5cm}
```
...
```{=tex}
\small
\textbf{Figura 5}. Sistema de niveles para la determinación de los PBRs de acuerdo a la cantidad, tipo y la calidad de la información disponible y, métodos de evaluación de stock empleados en cada pesquería. 
\normalsize 
\vspace{0.5cm}
```
...
```{=tex}
\begin{center}
\includegraphics[width=0.6\textwidth]{Figuras/DFgeneral.pdf}
\end{center}
```

```{=tex}
\small
\textbf{Figura 6}. Diagrama de fase definido por el CCT-PP para las pesquerías de pelágicos pequeños. 
\normalsize 
\vspace{0.5cm}
...
```{=tex}
\small
\textbf{Figura 7}. Captura en número estimada por el modelo alternativo utilizando clave talla-edad simulada. 
\normalsize 
\vspace{0.5cm}
```
...
*"Implementar procedimientos de evaluación de stock basados en protocolos científicos para la determinación del estatus de sardina austral, con arreglo al nivel de información, conocimiento e incertidumbre correspondiente, conforme a los estándares actuales en ciencia pesquera."* \vspace{0.3cm}
...
\vspace{-0.5cm}
\small
\textbf{Figura 9}. Variación mensual de las capturas de sardina austral en aguas interiores del Mar de Chiloé entre los años 2016 y 2019. 
\normalsize 
\vspace{0.5cm}
```
...
El análisis de esta pieza de información, sugiere que el modelo con interacciones podría representar, actualmente, de mejor forma la variabilidad de la CPUE considerando el mayor nivel de explicación de la desvianza. En la **Figura 10**, se muestra la variabilidad del índice estandarizado a través del modelo tweedie con y sin interacciones. La fuerte reducción en el índice los últimos dos años es también coherente con la disminución observada en los desembarques y en el crucero de evaluación directa.

```{=tex}
\begin{center}
\includegraphics[width=0.8\textwidth]{Figuras/seriehistoricaCPUE.pdf}
\end{center}
\small 
\textbf{Figura 10}. CPUE estandarizada por Modelos Lineales Generalizados (tweedie original y con interacciones), en la pesquería de sardina austral en aguas interiores de la isla de Chiloé. 
\normalsize
\vspace{0.5cm}
```
...
```{=tex}
\begin{center}
\includegraphics[width=1\textwidth]{Figuras/BiomasasCrucerosAcústicos.pdf}
\end{center}
\small
\textbf{Figura 11}. Biomasa total de sardina austral en aguas interiores de la Región de Los Lagos estimada en los cruceros de evaluación directa (2006-2020). Se destaca en círculo rojo de mayor tamaño el último valor obtenido en abril del año 2020. 
\normalsize
```
\pagebreak
...
Las **Figuras 12 y 13** muestran las estructuras de longitudes utilizadas en la evaluación de stock, la cual es obtenida desde la flota que opera en aguas interiores de la Región de Los Lagos y del crucero de evaluación directa realizado en la misma zona. \vspace{0.5cm}

```{=tex}
\begin{center}
\includegraphics[width=1\textwidth]{Figuras/TallasFlotas.pdf}
\end{center}
\small
\textbf{Figura 12}. Estructuras de longitudes (LT, cm) anual de sardina austral obtenida desde la flota que opera en aguas interiores de la Región de Los Lagos. 
\normalsize
```
```{=tex}
\begin{center}
\includegraphics[width=1\textwidth]{Figuras/TallasCruceros.pdf}
\end{center}
\small
\textbf{Figura 13}. Estructuras de longitudes (LT, cm) de sardina austral obtenida por el crucero de evaluación directa en aguas interires de la Región de Los Lagos. 
\normalsize
```
\vspace{0.3cm}

Para revisar el proceso de reclutamiento de sardina austral de la Región de Los Lagos se analiza la evolución mensual de la estructura de longitudes de sardina austral entre enero de 2013 y mayo de 2020 en el mar interior de la Región de Los Lagos se muestra en las **Figuras 14 y 15**. Aunque no se aprecia un patrón claro y persistente en el ingreso a la pesquería de la fracción recluta (menor a 12 cm), es posible apreciar evidencias de este proceso entre los meses de abril y mayo. Los años 2013 y 2014, se observa la presencia de una moda de individuos pequeños que recluta a la población a partir de abril. Esto se observó en septiembre de 2015 y en menor proporción en abril y mayo de 2016. La estructura de longitudes obtenida del muestro de la flota durante los años 2017 y 2018, muestra una estructura bimodal con una fuerte presencia de ejemplares reclutas que crecen en tamaño desde enero a mayo y una moda secundaria de adultos que marca una presencia constante y estable en términos de tamaño. Los primeros meses del 2019, se aprecia mayor presencia de individuos adultos, sobre los 13 cm, luego a partir de abril, excepto mayo, se confirma un pulso de ejemplares de pequeño tamaño bajo los 12 cm. El año 2020, aunque no se cuenta con información para el mes de abril, la estructura de longitudes entre enero y mayo muestra solo ejemplares adultos, sobre los 11 cm.

```{=tex}
\begin{center}
\includegraphics[width=1\textwidth]{Figuras/EstructurasTallasMensuales_1.pdf}
\end{center}
\small
\textbf{Figura 14}. Estructura de tallas mensual de las capturas de sardina austral (enero 2013 -diciembre 2016), en aguas interiores de la Región de Los Lagos. 
\normalsize
```
```{=tex}
\begin{center}
\includegraphics[width=1\textwidth]{Figuras/EstructurasTallasMensuales_2.pdf}
\end{center}
\small
\textbf{Figura 15}. Estructura de tallas mensual de las capturas de sardina austral (enero 2013 -diciembre 2016), en aguas interiores de la Región de Los Lagos. 
\normalsize
```
\vspace{0.3cm}

La **Figura 16** muestra un análisis comparativo de la estructura de longitudes observada desde la flota y cruceros de evaluación directa durante el mes de abril/mayo. En general, ambas fuentes de información son coincidentes en la distribución de frecuencia de tamaños que presenta el stock en el área, excepto el año 2018. El 2019, la estructura se basa casi exclusivamente en ejemplares de pequeño tamaño, por debajo de la ojiva de madurez. Lo contario se observa durante el año 2020, donde se observa una composición de tamaños concentrada en ejemplares adultos. El crucero aprecia una pequeña proporción de individuos entre 7,5 y 10 cm.

```{=tex}
\begin{center}
\includegraphics[width=1\textwidth]{Figuras/EstructurasTallasCruceros_flota.pdf}
\end{center}
\small
\textbf{Figura 16}. Estructura de tallas de sardina austral obtenida desde la flota (superficie sombreada) y crucero de evaluación directa (línea) en aguas interiores de la Región de Los Lagos, durante el mes de abril en los años 2017, 2018, 2019 y 2020. 
\normalsize
```
\vspace{0.3cm}
...
Para estimar la fracción desovante del stock, se utiliza la función de madurez descrita por Leal *et al*., (2011) (**Figura 17**). Los parámetros $\beta_0$ y $\beta_1$ que describen la ojiva de madurez en longitud para la especie alcanzaron valores de 25,87 y -1,91 respectivamente, con error estándar de 2,61 para $\beta_0$ y de 0,20 para $\beta_1$. \vspace{0.5cm}

```{=tex}
\begin{center}
\includegraphics[width=0.6\textwidth]{Figuras/ojivaMadurez.pdf}
\end{center}
\small
\textbf{Figura 17}. Ojiva de madurez de sardina austral en aguas interiores de la Región de Los Lagos obtenida a través de estados microscópicos (Leal *et al*., 2011). 
\normalsize
\vspace{0.5cm}
```
b)  Crecimiento y mortalidad natural

Los parámetros de crecimiento estimados por Cerna *et al*., (2007) para sardina austral fueron: $L_\infty$=17,7 cm, $k$=0,78 y $t_0$=-0,46 años (**Figura 18**). La mortalidad natural en tanto, fue estimada en 0,83 año-1 por Canales *et al*., (2007) utilizando los parámetros de crecimiento y madurez reportados para la especie. Esta información es la más actual disponible y es usada en el modelo de evaluación de stock.

```{=tex}
\begin{center}
\includegraphics[width=0.6\textwidth]{Figuras/curvaCrecimiento.pdf}
\end{center}
\small
\textbf{Figura 18}. Función de crecimiento descrita por los parámetros de Von Bertalanffy estimados para sardina austral.
\normalsize
```
\pagebreak
...
### 4.2.1. Matriz de transición de crecimiento talla-talla (Modelo base)
...
### 4.2.2. Clave talla-edad simulada en modelo alternativo
...
### 4.2.3. Comparación del ajuste y residuales del modelo base y alternativo a los datos
...
### 4.2.4. Comparación del análisis retrospectivo del modelo base y alternativo
...
### 4.2.5. Comparación de los perfiles de verosimilitud del modelo base y alternativo
...
```{r F33_retrospectivo_base, echo=FALSE, message=FALSE, warning=FALSE, include=T, fig.align="center", fig.height=10, fig.width=8,fig.path=dir.Fig,dev=fig}
...
```{r F33_retrospectivo_alternativo, echo=FALSE, message=FALSE, warning=FALSE, include=T, fig.align="center", fig.height=10, fig.width=8,fig.path=dir.Fig,dev=fig}
...
```{r F_verosimilitud_base, echo=FALSE, message=FALSE, warning=FALSE, include=T, fig.align="center", fig.height=4, fig.width=5,fig.path=dir.Fig,dev=fig}
...
\normalsize
```
```{r F_verosimilitud_alternativo, echo=FALSE, message=FALSE, warning=FALSE, include=T, fig.align="center", fig.height=4, fig.width=5,fig.path=dir.Fig,dev=fig}
...
### 4.2.6. Comparación de las tendencias poblacionales del modelo base y alternativo
...
\normalsize
```
### 4.2.7. Comparación del Estado de explotación estimado por el modelo base y alternativo
...
### 4.2.8. Comparación con asesorías previas
...
### 4.2.9. Comparación de la proyección de la Captura Biológicamente Aceptable (CBA inicial - Hito 1)
...
### 4.2.10. Comparación de CBA calculado para el mismo año (Revisión de CBA - Hito 2)
