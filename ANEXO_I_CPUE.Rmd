...
\begin{figure}[htb!]
\centering
\includegraphics[width=12.5cm,height=8.5cm]{Figuras/Figura7_anexo1.png}
...
\caption{Análisis de los residuos en la estandarización de la CPUE a través de: a) modelo Gamma y b) Poisson compuesta.}
\label{Fig9anexo}
\end{figure}
```
