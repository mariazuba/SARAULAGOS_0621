...
```{r Fig20_anexoIII,warning=F, include=T, message=F,eval=F, echo=T,fig.height=8,fig.width=10,fig.align="center",fig.path="Figuras/",dev=c('pdf')}
...
```{r Fig21a_anexoIII, warning=F, include=T, message=F,eval=F, echo=T,fig.height=4,fig.width=4,fig.align="center",out.extra = 'angle=0',fig.path="Figuras/",dev=c('pdf')}
...
```{r Fig22b_anexoIII, warning=F, include=T, message=F,eval=F, echo=T,fig.height=4,fig.width=4,fig.align="center",fig.path="Figuras/",dev=c('pdf')}
...
```{r Fig28_anexoIII,warning=F, include=T, message=F, echo=T,fig.height=5.8,fig.width=4,fig.align="center",fig.path="Figuras/",dev=c('pdf')}
