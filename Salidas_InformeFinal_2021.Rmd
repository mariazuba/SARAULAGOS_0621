...
```{r antecedentes_desembarques,warning=F, include=T, message=F,eval=F, echo=FALSE,fig.height=3.5,fig.width=5,fig.align="center",fig.path="Figuras/",dev=fig}
...
```{r estructura_mensual,eval=F,warning=F, include=T, message=F, echo=FALSE,fig.height=7.5,fig.width=6,fig.align="center",fig.path="Figuras/",dev=fig}
...
```{r arreglos_residuales_indices,warning=F, include=T, message=F, echo=FALSE,eval=TRUE,fig.height=11,fig.width=9,fig.align="center",fig.path="Figuras/",dev=c('pdf')}
